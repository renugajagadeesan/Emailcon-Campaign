                  ...
                  <>
                   <label>Button name:</label>
                    <input
                      ...
                      onChange={(e) =>
                        updateContent(selectedIndex, { content: e.target.value })
                      }
                    />
                    <div className="editor-bg">
                      Background Color
        ...
        <>
         <label>Button-1 Name:</label>
                    <input
                      ...
                      onChange={(e) =>
                        updateContent(selectedIndex, { content1: e.target.value })
                      }
                    />
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent(selectedIndex, { content2: e.target.value })
                      }
                    />
            ...
            <input
              ...
              onChange={(e) =>
                updateContent(selectedIndex, { link1: e.target.value })
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                updateContent(selectedIndex, { link2: e.target.value })
              }
            />
          ...
          <div className="editor-bg">
            ...
            <input
              type="color"
              value={previewContent[selectedIndex].buttonStyle.color}
              onChange={(e) =>
                updateContent(selectedIndex, {
                  buttonStyle: {
          ...
          <div className="editor-bg">
            ...
            <input
              type="color"
              value={previewContent[selectedIndex].buttonStyle.backgroundColor}
              onChange={(e) =>
                updateContent(selectedIndex, {
                  buttonStyle: {
                    ...previewContent[selectedIndex].buttonStyle,
           ...
           <label>Text Alignment:</label>
                    <select
                      value={
                        previewContent[selectedIndex]?.buttonStyle?.textAlign || ""
                      }
                      onChange={(e) =>
                        updateContent(selectedIndex, {
                          buttonStyle: {
